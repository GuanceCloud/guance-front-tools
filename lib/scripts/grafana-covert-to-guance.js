...
const covert = (grafanaData) => {
  ...
  // 视图变量
  const guanceVars = []
  ;(_b = (_a = grafanaData.templating) === null || _a === void 0 ? void 0 : _a.list) === null || _b === void 0
    ? void 0
    : _b.forEach((_variable, index) => {
  ...
  let lastPanels = []
  let grafanaCharts =
    ((_c = grafanaData.panels) === null || _c === void 0
      ? void 0
      : _c.filter((_panel) => _panel.type === 'row' || grafanaPanelTypeToGuanceChartMap[_panel.type])) || []
  ...
  grafanaCharts.forEach((_panel) => {
    ...
    if (_panel.type === 'row') {
      ...
      if (_rowPanel.collapsed) {
        // 收起
        const subPanels =
          ((_a = _rowPanel.panels) === null || _a === void 0
            ? void 0
            : _a.filter((_panel) => _panel.type === 'row' || grafanaPanelTypeToGuanceChartMap[_panel.type])) || []
