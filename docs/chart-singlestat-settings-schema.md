# ChartSinglestatSettings Schema

```txt
charts/settings/chart-singlestat-settings-schema.json
```
...
## ChartSinglestatSettings Type

`object` ([ChartSinglestatSettings](chart-singlestat-settings-schema.md))
...
# ChartSinglestatSettings Properties
